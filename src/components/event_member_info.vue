...
const fetchMemeberInfo = async () => {
  try {
    ...
    const response = await axios.get(`${config.url}/api/v1/event-members/${memberId}`);
...
<template>
  ...
  <div class="container">
    <div class="member-card">
      ...
      <h2>
        <svg v-if="memberData.approved === 'NOT_APPROVED'" xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="red"
        ...
        <svg v-if="memberData.approved === 'APPROVED'" xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="green"
